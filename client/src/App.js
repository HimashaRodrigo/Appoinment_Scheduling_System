...
import AdminAddJobCategory from "./pages/Admin/Admin_Add_Job_Category";
      ...
      <Fragment>
        ...
        <Toaster position="top-center" reverseOrder={false} />
          <Routes>
            ...
            <Route path="/admin-job-categories" element={<AdminAddJobCategory menuItems={DashBoardLinks[0].Navs} backRoutes={BackRoutes[0].link}/>}/>
